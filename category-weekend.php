<?php get_header(); ?>
    ...
    <div class="page-3">
        <div class="headDiv">
            <p class="p1">ACCA协会授予白金级培训资质的高校</p>
            <p>上海财经大学   通过率高达60%-70%</p>
        </div>
        <p class="pagePos">您所在的位置：首页-面授课程-周末班</p>
        <div class="section-1-0">
            <img src="<?php echo get_bloginfo("template_url") ?>/img/3-img1-1.jpg ?>" />
            <div class="info">
                <p class="mainTitle"><span></span>ACCA周末班</p>
                <p class="h1">【适合人群】</p>
                <p>在职白领，海归人士， 会计、财务管理、金融、或其他管理类专业以及其他想学习ACCA的学员</p>
                <p class="h1">【开课时间】</p>
                <p>周六周日上课，共计536课时</p>
                <p class="h1">【课程介绍】</p>
                <p>本课程涵盖各科目的基础课、真题讲解课以及串讲冲刺课，并提供所报课程课堂教学实录，以便学员温习回顾。采用班级化教学，配备优秀专业讲师团队，帮助学员快速通过考试，为学员的学习生活提供便捷化服务。教学师资由上海国际银行金融学院选派优秀的上海财经大学师资到合作高校授课，F阶段9门功课，共计536课时。</p>
                <p class="h1">【考试时间及地点】</p>
                <p>2017年开始所有省会城市都设有考点，考试是全英文机考或笔考，一年4次的考试，分别是3月，6月，9月，12月。机考考点每月都可预约参加考试。</p>
                <p>如果本期学员没有通过考试，可参加下一期班免费重修，参加后期的考试，补考费用由学员自理。</p>
            </div>
        </div>

        <div class="section-2">
            <img class="title" src="<?php echo get_bloginfo("template_url") ?>/img/3-title1.png" />
            <div class="content">
        ...
        <img class="img2" src="<?php echo get_bloginfo("template_url") ?>/img/3-img2.jpg">
    </div>
<?php get_footer(); ?>